...
class Channel {
  ...
  Future<Map<String, dynamic>> createSubAccount({String name = 'wallet', String walletType = 'p2sh-p2wpkh', String? mnemonic, String connectionType = 'electrum-mainnet' }) async {mnemonic ??= "";
  ...
  Future<Map<String, dynamic>> getReceiveAddress({int pointer = 1, String mnemonic = "", String connectionType = 'electrum-mainnet', bool isInternal = false}) async {
  ...
  Future<Map<String, dynamic>> getFeeEstimates({ String mnemonic = "", String connectionType = 'electrum-mainnet'}) async {
    final feeEstimates = await platform.invokeMethod('getFeeEstimates', <String, dynamic>{
      'mnemonic': mnemonic,
      'connectionType': connectionType,
    });
