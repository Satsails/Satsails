...
Widget buildDiagram(BuildContext context, Percentage percentage) {
  return percentage.total == 0
    ...
    sections: [
      PieChartSectionData(value: percentage.btcPercentage, title: '', radius: 20, badgeWidget: const Icon(Icons.currency_bitcoin, color: Colors.white), color: Colors.orange),
      PieChartSectionData(value: percentage.liquidPercentage, title: '', radius: 20, badgeWidget: const Icon(MingCute.lightning_line, color: Colors.white), color: Colors.orangeAccent.shade700),
      PieChartSectionData(value: percentage.brlPercentage, title: '', radius: 20, badgeWidget: Flag(Flags.brazil, size: 25), color: Colors.greenAccent),
