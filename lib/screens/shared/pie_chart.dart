...
Widget buildDiagram(BuildContext context, Percentage percentage) {
  return percentage.total == 0
    ...
    sections: [
      ...
      PieChartSectionData(value: percentage.liquidPercentage, title: '', radius: 20, badgeWidget: const Icon(Icons.water_drop, color: Colors.white), color: Colors.blueAccent),
