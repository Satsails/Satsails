...
extension Localization on String {
  static final _t = Translations.byText('en') +
      ...
      {
        'en': 'Invalid payment type for Spark. Expected Lightning or Bitcoin.',
        'pt': 'Tipo de pagamento inválido para Spark. Esperado Lightning ou Bitcoin.',
      } +
      {
        'en': 'Scanned payment type does not match expected type',
        'pt': 'Tipo de pagamento escaneado não corresponde ao tipo esperado',
      } +
      {
        'en': 'Select a date range to view chart data.',
        'pt': 'Selecione um intervalo de datas para visualizar os dados do gráfico.',
      } +
      {
        'en': 'Total Value: %s\n',
        'pt': 'Valor Total: %s\n',
      ...
      {
        'en': 'Depix purchases are reported to the Brazilian federal revenue agency.',
        'pt': 'As compras de Depix são reportadas à Receita Federal brasileira.',
      } +
      {
        'en': 'Depix tokens are registered under the payer\'s name.',
        'pt': 'Os tokens Depix são registrados em nome do pagador.',
      } +
      {
        'en': 'Conversions to Bitcoin are not reported automatically, allowing for relatively anonymous Bitcoin purchases.',
        'pt': 'As conversões para Bitcoin não são reportadas automaticamente, permitindo compras de Bitcoin relativamente anônimas.',
      } +
      {
        'en': '*Always comply with the laws of your jurisdiction.',
        'pt': '*Sempre cumpra as leis de sua jurisdição.',
      } +
      {
        'en': 'Syncing',
        'pt': 'Sincronizando',
      ...
      } +
      {
        ...
        'pt': 'Ajude-nos a melhorar avaliando o aplicativo!',
      } +
      {
        'en': 'Currency Denomination',
        'pt': 'Denominação da Moeda',
      } +
      {
        'en': '%s copied to clipboard!',
        'pt': '%s copiado para a área de transferência!',
      } +
      {
      ...
      {
        'en': 'Receive on Bitcoin Network',
        'pt': 'Receber na rede do Bitcoin',
      } +
      {
        'en': 'Receive on Spark Network',
        'pt': 'Receber na rede do Spark',
      } +
      {
        'en': 'Receive on Liquid Network',
        'pt': 'Receber na rede do Liquid',
      } +
      {
        'en': '(Optional)',
        'pt': '(Opcional)',
      ...
      } +
      {
        ...
        'pt': 'Digite o endereço do destinatário',
      } +
      {
        'en': 'Amount:',
        'pt': 'Quantidade:',
